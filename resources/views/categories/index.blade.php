                ...
                <tr>
                    ...
                    <td>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{route('categories.show', $category)}}" class="btn btn-primary me-md-2">Visualizza</a>

                            @auth
                            <a href="{{route('categories.edit', $category)}}" class="btn btn-warning me-md-2">Modifica</a>
